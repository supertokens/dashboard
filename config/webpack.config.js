	...
	return {
		...
		resolve: {
			...
			alias: {
				...
				"@styles": path.resolve(paths.appSrc, "ui/styles"),
				"@utils": path.resolve(paths.appSrc, "utils"),
				"@services": path.resolve(paths.appSrc, "services"),
				"@assets": path.resolve(paths.appSrc, "assets"),
				"@constants": path.resolve(paths.appSrc, "constants.ts"),
				"@version": path.resolve(paths.appSrc, "version.ts"),
				"@types": path.resolve(paths.appSrc, "types.ts"),
				"@events": path.resolve(paths.appSrc, "events"),
