...
const TenantsListFooter = withOverride(
	"TenantsListFooter",
	function TenantsListFooter({ totalCount, currentPage, setCurrentPage, isSearch }: TenantsListFooterProps) {
...
export default TenantsListFooter;
