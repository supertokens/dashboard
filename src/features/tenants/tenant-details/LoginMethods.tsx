...
export const LoginMethods = withOverride(
	"LoginMethods",
	function LoginMethods({ tenantInfo }: { tenantInfo: TenantInfo }) {
					...
					<Flex
						...
						<Callout.Root
							...
							<Text
								...
								<span>{enabledFirstFactors.length} login methods enabled:</span> Users will be able to
								sign up using any of the selected methods
							</Text>
						</Callout.Root>
					</Flex>
				)}
...
export const LoginMethodItem = withOverride(
	"LoginMethodItem",
	function LoginMethodItem({ factorId, label, description, isEnabled, tenantId }: LoginMethodItemProps) {
