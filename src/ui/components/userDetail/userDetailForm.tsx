...
export const getUserChangePasswordPopupProps = (
    ...
    <>
      <div className='user-detail-form'>
        ...
        <div className='user-detail-form__actions'>
          <button className='button outline' onClick={() => onPasswordChange()}>
            Cancel
          </button>
          <button className='button' disabled={isSaveDisabled} onClick={() => onPasswordChange(password)}>
            Save
          </button>
        </div>
      </div>
...
export const UserDeleteConfirmation: FC<UserDeleteConfirmationProps> = ({ user, onConfirmed }) => {
  return (
    <div className='user-detail-form'>
      ...
      <div className='user-detail-form__actions'>
        <button className='button outline' onClick={() => onConfirmed(false)}>
          Cancel
        </button>
        <button className='button button-error' onClick={() => onConfirmed(true)}>
          Save
        </button>
      </div>
    </div>
